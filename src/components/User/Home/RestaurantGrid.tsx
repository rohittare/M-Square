...
//     picture: "https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8?w=500&h=350&fit=crop",
    ...
    <section className="py-6 sm:py-8">
      <div className="container mx-auto px-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1 sm:gap-0 mb-4 sm:mb-6">
          ...
          <span className="text-xs sm:text-sm text-muted-foreground">{shops.length * 10}+ restaurants</span>
        </div>
